...
|-----------|--------------|--------|------|
| **Firefox Multi-Account Containers** | I use this to automatically open various sites in a specific container; school has a container, various other things have their own containers, etc. | I think it's useful, but it's not mandatory. It's not for privacy in my case (and if you're using my configs, it's not for privacy in your case either), just to seperate cookies and sessions in one browser | [addons.mozilla.org](https://addons.mozilla.org/en-US/firefox/addon/multi-account-containers/) |
