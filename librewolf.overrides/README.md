...
> **Note:** Changing *any* preference in the about:config of your browser can potentially make you stand out significantly to fingerprinters and trackers. For this reason, please don't use my config if privacy is your #1 concern; Use stock LibreWolf, Mullvad Browser, Tor Browser, or Tails OS if you need super high levels of privacy &/or security. This config just tries to make LibreWolf into a usable, daily-driver browser that is private enough (more private than Firefox or Chrome, that's for sure at least).
