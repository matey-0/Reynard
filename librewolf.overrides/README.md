...
> **Note:** Changing *any* preference in the about:config of your browser can potentially make you stand out significantly for fingerprinters and trackers. For this reason, please don't use my config if privacy is your #1 concern. Use stock LibreWolf, Mullvad Browser, Tor, or Tails if you need super high levels of privacy &/or security. This config just tries to make LibreWolf into a usable, daily-driver browser that is private enough.
